<?php
    ...
    if(isset($_POST['forget'])){
      ...
      if(mysqli_num_rows($query_run)){
            ...
            $body = "Hi, $name, Click here to set a new password http://localhost/Project/Online%20Notice%20Board/teacher/forget_form.php?token=$token";
                        ...
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-0">
                                ...
                                <form action="forget.php" method="POST">
                                    ...
                                    <p class="text-center text-muted mt-1 mb-0">If You have no account <a href="teacher_signup.php"
